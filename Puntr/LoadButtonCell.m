...
- (void)loadButton
{
    if (!self.loaded)
    {
        self.imageViewTopLine = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.frame), 2)];
        [self addSubview:self.imageViewTopLine];
        
        self.button = [[UIButton alloc] initWithFrame:CGRectMake(10, 8, CGRectGetWidth(self.frame) - 20, 40)];
